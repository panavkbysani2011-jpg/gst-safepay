  ...
  return (
    ...
    >
      <LegalSection heading="In place today">
        <ul>
          <li><strong>Authentication on every request:</strong> all app routes are gated, and anyone who is not signed in is sent back to the login page.</li>
          <li><strong>Per-account isolation:</strong> every database query is scoped to the signed-in account, and we test that one account can never read another&apos;s data.</li>
